 ...
 */
public class OneKeyApplyProcessor extends BaseProcessor {

    public OneKeyApplyProcessor(Context context, RequestParams params) {
    ...
    public void sendPostRequest() {
        ...
        helper.sendPost(ServerConfig.URL_QUERY_MODEL_ACCESSORY, params, this);
    }
        ...
        try {
            ...
            if (jsonAppliance != null) {
                ...
                if (!TextUtils.isEmpty(result) && result.equals("S")) {
                    EventBus.getDefault().post(new OneKeyApplyEvent(jsonAppliance.getMaterialList()));
                } else {
