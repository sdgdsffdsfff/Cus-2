...
public class TaskHistoryListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            holder.cardView = (CardView) convertView.findViewById(R.id.cv_layout);
            ...
            holder.scheduleLabelTv = (TextView) convertView.findViewById(R.id.tv_task_item_schedule_label);
        ...
        if(task != null) {
            ...
            if (task.getStatus().equals("1") || task.getStatus().equals("2")) {
                holder.cardView.setCardBackgroundColor(mContext.getResources()
                        .getColor(R.color.cl_bg_task_unprocessed));
            } else {
