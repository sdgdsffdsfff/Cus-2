...
import com.suning.cus.activity.fragment.MyFavBackupFragment;
 ...
 */
public class BackupMyFavListAdapter extends BaseAdapter {
    ...
    public BackupMyFavListAdapter(Context context, int screenWidth) {
        mContext = context;
    ...
    public void appendDataList(List<BackupFavData> dataList) {
        ...
        if (this.dataList == null) {
            this.dataList = new ArrayList<BackupFavData>();
            size = 0;
        } else {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (checkStatus) {
            ...
            holder.addShopCarImageView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    bundle.putString(MyFavBackupFragment.CMMDTY_CODE, data.getCmmdtyCode());
                    bundle.putString(MyFavBackupFragment.CMMDTY_NAME, data.getCmmdtyName());
                    Message msg = new Message();
                    msg.what = MyFavBackupFragment.HANDLER_CODE_ADD_FAV;
                    msg.setData(bundle);
                    MyFavBackupFragment.handler.sendMessage(msg);
                }
            });
        }
        ...
        holder.delFavButtonSlide.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Bundle bundle = new Bundle();
                bundle.putString(MyFavBackupFragment.CMMDTY_CODE, data.getCmmdtyCode());
                bundle.putInt(MyFavBackupFragment.CMMDTY_POSITION, position);
                Message msg = new Message();
                msg.what = MyFavBackupFragment.HANDLER_CODE_DEL_FAV;
                msg.setData(bundle);
                MyFavBackupFragment.handler.sendMessage(msg);
            }
        });
